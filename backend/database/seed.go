	...
	var services = []models.Service{
		{
			...
			ShortDescription:   "KTP OCR has the ability to read Indonesian ID cards (KTP) which results in JSON output.",
		...
		},
		{
			...
			SpecialInstruction: "Special Instruction for Rotten Fruit Detection",
			CreatedAt:          time.Now(),
			UpdatedAt:          time.Now(),
		},
